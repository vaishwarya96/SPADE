...
class SPADEGenerator(BaseNetwork):
    ...
    def __init__(self, opt):
        ...
        self.G_middle_1 = NormalResnetBlock(16 * nf, 16 * nf, opt)

        self.up_0 = NormalResnetBlock(16 * nf, 8 * nf, opt)
        self.up_1 = NormalResnetBlock(8 * nf, 4 * nf, opt)
        self.up_2 = NormalResnetBlock(4 * nf, 2 * nf, opt)
        self.up_3 = NormalResnetBlock(2 * nf, 1 * nf, opt)
